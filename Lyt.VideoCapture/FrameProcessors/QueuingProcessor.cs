...
public abstract class QueuingProcessor : FrameProcessor
{
    ...
    private protected QueuingProcessor(int maxQueuingFrames, BufferPool bufferPool) : base(bufferPool)
    {
...
public sealed class DelegatedQueuingProcessor : QueuingProcessor
{
