...
// TODO : Figure out if all of this is truly needed 

/// <summary> Fraction number structure. </summary>
...
public readonly struct Fraction : IEquatable<Fraction>, IComparable<Fraction>
{
    ...
    public static Fraction Create(int numerator, int denominator) => new(numerator, denominator);
    
    public static Fraction Create(int value) => new(value, 1);
    ...
    /// <summary> Reduce this fraction. </summary>
    /// <returns>Reduced fraction</returns>
    public Fraction Reduce() => Fraction.Reduce(this.Numerator, this.Denominator);

    /// <summary> Get reciprocal fraction. (Inverse)  </summary>
    /// <returns>Reciprocal fraction</returns>
    public Fraction Reciprocal() => new(this.Denominator, this.Numerator);

    private void Prepare(in Fraction rhs, out long pd, out long tn, out long rn)
    {
    ...
    /// <summary> Add fraction number. </summary>
    ...
    public Fraction Add(Fraction rhs, bool reduce = true)
    {
        ...
        this.Prepare(in rhs, out long pd, out long tn, out long rn);
        long pn = tn + rn;
        return reduce ? Reduce(pn, pd) : new Fraction((int)pn, (int)pd);
    }

    /// <summary> Multiple fraction number.
    /// </summary>
    /// <param name="rhs">Fraction</param>
    /// <param name="reduce">Perform reducing fraction when calculated</param>
    /// <returns>Calculated fraction</returns>
    ...
    {
        long pn = (long)this.Numerator * rhs.Numerator;
        long pd = (long)this.Denominator * rhs.Denominator;
        return reduce ? Reduce(pn, pd) : new Fraction((int)pn, (int)pd);
    }
    ...
    /// <summary> Pretty printer. </summary>
    ...
    /// <summary> Zero instance of fraction. </summary>
    ...
    public static Fraction operator +(Fraction lhs, Fraction rhs) => lhs.Add(rhs);

    /// <summary> Subtract fraction number. </summary>
    /// <param name="lhs">Fraction number</param>
    /// <param name="rhs">Fraction number</param>
    /// <returns>Fraction</returns>
    ...
    /// <summary> Multiple fraction number. </summary>
    /// <param name="lhs">Fraction number</param>
    /// <param name="rhs">Fraction number</param>
    /// <returns>Fraction</returns>
    public static Fraction operator *(Fraction lhs, Fraction rhs) => lhs.Mult(rhs);

    /// <summary> Divide fraction number. </summary>
    /// <param name="lhs">Fraction number</param>
    /// <param name="rhs">Fraction number</param>
    /// <returns>Fraction</returns>
    public static Fraction operator /(Fraction lhs, Fraction rhs) => lhs.Mult(rhs.Reciprocal());

    /// <summary> Modulo fraction number. </summary>
    /// <param name="lhs">Fraction number</param>
    /// <param name="rhs">Fraction number</param>
    /// <returns>Fraction</returns>
    public static Fraction operator %(Fraction lhs, Fraction rhs) => lhs.Mod(rhs);
