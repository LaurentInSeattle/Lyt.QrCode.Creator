...
#pragma warning disable SYSLIB0051 // OBSOLETE 
...
#pragma warning restore SYSLIB0051 
    ...
    public class MFError
    {
        ...
        public void ThrowExceptionForHR() => ThrowExceptionForHR(LastError);

        public static void ThrowExceptionForHR(HResult hr) => ThrowExceptionForHR((int)hr);

        public static string MessageFromHResult(int hr) => Marshal.GetExceptionForHR(hr).Message;
        ...
        public static void ThrowExceptionForHR(int hr)
        {
            ...
            if (hr < 0)
            {
                Debug.WriteLine("*** HResult: " + MessageFromHResult(hr) + " HR = 0x" + hr.ToString("X"));
                var mfe = new MFException(hr);
                Debug.WriteLine("*** Exception: " + mfe.Message);
                var inner = mfe.InnerException;
                if (inner != null)
                {
