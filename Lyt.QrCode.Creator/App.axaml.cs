namespace Lyt.QrCode.Creator;

public partial class App : ApplicationBase
{
    public const string Organization = "Lyt";
    public const string Application = "QrCode Creator";
    public const string RootNamespace = "Lyt.QrCode.Creator";
    public const string AssemblyName = "Lyt.QrCode.Creator";
